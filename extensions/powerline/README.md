...
|------|---------|-------------|
| `basename` | `powerline` | Just the directory name (default) |
| `abbreviated` | `…/extensions/powerline` | Full path with home abbreviated and length limit |
| `full` | `~/.pi/agent/extensions/powerline` | Complete path with home abbreviated |
